...
<div class="container">
  <form role="form" ng-submit="mc.add()">
		<div class="box1">
			<div class="form-group col-sm-4">
				<label for="issueProject"><spring:message code="issue.project"/></label>
				<select ng-model="mc.createIssue.project.projectId" class="dropDown form-control">
		   ...
		   <div class="form-group col-sm-4">
				...
				<select ng-model="mc.createIssue.issueType.issueId" class="dropDown form-control">
		   ...
		   <div class="form-group col-sm-4">
				...
				<select ng-model="mc.createIssue.issuePriority.issuePriorityId" class="dropDown form-control">
		...
		<div class="form-group col-sm-12">
			...
			<input type="text" ng-model="mc.createIssue.issueSummary" class="form-control" />
	   </div>
	  <div class="box2 ">
		   <div class="form-group col-sm-6">
			<label for="creationDate"><spring:message code="issue.creationDate"/></label>
			<input type="date" ng-model="mc.createIssue.issueCreationDate" class="form-control" disabled/>
		  </div>
		  <div class="form-group col-sm-6">
			<label for="dueDate"><spring:message code="issue.dueDate"/></label>
			<input type="date" ng-model="mc.createIssue.issueDueDate" class="form-control" />
		  </div>
	  </div>
	  <div class="box3 ">
		   <div class="form-group col-sm-4">
			<label for="component"><spring:message code="issue.component"/></label>
			<input type="text" ng-model="mc.createIssue.issueComponent" class="form-control" />
		  </div>
		  <div class="form-group col-sm-4">
			<label for="affectedVersion"><spring:message code="issue.affectedVersion"/></label>
			<input type="text" ng-model="mc.createIssue.issueAffectedVersion" class="form-control" />
		  </div>
		  <div class="form-group col-sm-4">
			<label for="environment"><spring:message code="issue.environment"/></label>
			<input type="text" ng-model="mc.createIssue.issueEnvironment" class="form-control" />
		  </div>
	  </div>
	  <div class="box4">
			<div class="form-group col-sm-12">
				<label for="description"><spring:message code="issue.Description"/></label>
				<textarea class="form-control" rows="5" ng-model="mc.createIssue.issueDescription" class="form-control" ></textarea>
			</div>
	  </div>
	  <div class="box5">
		   <!-- <div class="form-group col-sm-6">
		  ...
		  <div class="form-group col-sm-4">
				...
				<select class="dropDown form-control" ng-model="mc.createIssue.user.userId" class="form-control" >
